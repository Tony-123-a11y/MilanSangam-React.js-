  ...
  return (
    <div className="flex-1 h-full  flex flex-col bg-gray-50">
      <>
        ...
        {/* Messages */}
        {loadingMessage ? (
          <div className=" flex-1 flex items-center justify-center text-primary font-bold">
            Loading Messages...
          </div>
        ) : (
          <div
            ref={chatRef}
            className="flex-1  overflow-y-scroll max-h-[calc(100vh-216px)] p-4 space-y-4 custom-scrollbar"
          >
                ...
                >
                  ...
                  <p
                    className={`text-xs mt-1 ${
                      msg.senderId === "me" ? "text-amber-100" : "text-gray-500"
                    }`}
                  >
                    {msg.time}
                  </p>
